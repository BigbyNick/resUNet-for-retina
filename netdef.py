...
def _getNet(n):
    ...
    score1 = conv(temp, (1, 1), (1, 1), (0, 0), k, 'score1')
...
if __name__ == '__main__':
    pass
    net = getNet(21)
    mx.viz.plot_network(net, save_format='png', shape={
        'data': (1, 3, 640, 640),
        'softmax1_label': (1, 640, 640), }).render('deep-unet')
